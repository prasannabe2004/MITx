...
#True
print myHand
#eiioooppqqqrtuuuwwyy

print '------------NEGATIVE----------'
########################NEGATIVE CASE##########################
myHand = Hand(10)
myHand.setDummyHand('apppemwwtx')
...
myHand = Hand(10)
myHand.setDummyHand('peplaebjxe')
print myHand.update('apple')
#: True
print myHand
#beejx
...
myHand = Hand(11)
myHand.setDummyHand('roartandaku')
print myHand.update('carrot')
#: False
print myHand
#aaadknorrtu

myHand = Hand(10)
myHand.setDummyHand('hehhhwsmgc')
